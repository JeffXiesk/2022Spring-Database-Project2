<template>
  ...
  <div class="table_vi">
    <el-table :data="tableData" stripe table-layout="fixed" align="center">
      ...
      <el-table-column prop="manager" label="Manager" align="center"/>
...
export default {
  methods:{
    ...
    page(currentPage){
      const _this = this;
      var url = 'http://localhost:8181/contract/findAll/'+currentPage+'/10'
  ...
  created(currenPage){
    const _this = this;
    axios.get('http://localhost:8181/contract/findAll/1/10').then(function (resp) {
      _this.tableData = resp.data.content;
      _this.total = resp.data.totalElements;
    })
  },
