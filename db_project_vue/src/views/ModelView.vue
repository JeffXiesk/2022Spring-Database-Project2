<template>
  ...
  <div class="table_vi">
    <el-table :data="tableData" stripe table-layout="fixed" align="center">
      ...
      <el-table-column prop="unit_price" label="Unit Price" align="center"/>
    </el-table>
...
export default {
  methods:{
    ...
    page(currentPage){
      const _this = this;
      var url = 'http://localhost:8181/model/findAll/'+currentPage+'/10'
  ...
  created(currenPage){
    ...
    axios.get('http://localhost:8181/model/findAll/1/10').then(function (resp) {
      _this.tableData = resp.data.content;
      _this.total = resp.data.totalElements;
    })
    console.log('after axios')
