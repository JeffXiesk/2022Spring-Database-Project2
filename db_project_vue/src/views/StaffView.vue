<template>
  ...
  <div class="table_vi">
    <el-table :data="tableData" stripe table-layout="fixed" align="center">
      ...
      <el-table-column prop="mobile_number" label="Mobile Number" align="center"/>
...
export default {
  methods:{
    ...
    page(currentPage){
      const _this = this;
      var url = 'http://localhost:8181/staff/findAll/'+currentPage+'/10'
  ...
  created(currenPage){
    const _this = this;
    axios.get('http://localhost:8181/staff/findAll/1/10').then(function (resp) {
      _this.tableData = resp.data.content;
      _this.total = resp.data.totalElements;
    })
  },
